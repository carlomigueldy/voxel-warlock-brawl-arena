...
export const SPELLS = {
  // ---- Core projectiles ----
  fireball:  { name: "Fireball",  key: "1", cd: 0.55, kind: "projectile", proj: "fireball",  kb: 7,  color: 0xff5a1e, sfx: "fireball",  desc: "Fast bolt that knocks foes back." },
  lightning: { name: "Lightning", key: "2", cd: 4.0,  kind: "lightning",  range: 16, kb: 9, chains: 2, chainRange: 7, color: 0x9fe6ff, sfx: "lightning", desc: "Lightning that chains to nearby enemies." },
  boomerang: { name: "Boomerang", key: "3", cd: 6.0,  kind: "projectile", proj: "boomerang", kb: 8,  range: 16, color: 0xffe14c, sfx: "whoosh",    desc: "Returning projectile that hits on the way back." },
  homing:    { name: "Homing",    key: "4", cd: 8.0,  kind: "projectile", proj: "homing",    kb: 9,  turn: 3.2, color: 0xc04cff, sfx: "homing",    desc: "Tracking bolt that hunts down its target." },
  fireSpray: { name: "Fire Spray", key: "5", cd: 7.0, kind: "spray",      proj: "fireball",  kb: 5,  count: 7, spread: 0.9, color: 0xff7a2e, sfx: "spray",    desc: "Fan of fire bolts covering a wide arc." },
  bouncer:   { name: "Bouncer",   key: "6", cd: 9.0,  kind: "projectile", proj: "bouncer",   kb: 8,  bounces: 4, color: 0x4cff9c, sfx: "whoosh",   desc: "Ricochets off walls up to four times." },
  splitter:  { name: "Splitter",  key: "7", cd: 9.0,  kind: "projectile", proj: "splitter",  kb: 6,  splitDist: 7, shards: 5, color: 0xff4ca8, sfx: "fireball", desc: "Splits into five piercing shards on impact." },
  meteor:    { name: "Meteor",    key: "8", cd: 12.0, kind: "meteor",     range: 18, fall: 1.1, radius: 5, kb: 22, color: 0xff3a1e, sfx: "meteor",   desc: "Calls a falling meteor with a heavy blast." },

  // ---- Mobility ----
  teleport:  { name: "Teleport",  key: "Q", cd: 8.0,  kind: "teleport",  range: 14, sfx: "teleport", desc: "Blink instantly toward your aim." },
  thrust:    { name: "Thrust",    key: "E", cd: 7.0,  kind: "thrust",    power: 26, sfx: "whoosh",   desc: "Launches you forward with great force." },
  swap:      { name: "Swap",      key: "R", cd: 14.0, kind: "swap",      range: 18, sfx: "teleport", desc: "Swaps positions with a distant target." },
  ...
  // ---- Control / utility ----
  drain:     { name: "Drain",     key: "V", cd: 12.0, kind: "drain",     range: 12, pull: 10, steal: 0.5, sfx: "drain",      desc: "Pulls an enemy close and siphons their charge." },
  gravity:   { name: "Gravity",   key: "X", cd: 14.0, kind: "gravity",   range: 16, radius: 6, duration: 2.5, pull: 14, sfx: "gravity", desc: "Creates a gravity well that pulls nearby foes." },
  link:      { name: "Link",      key: "Z", cd: 16.0, kind: "link",      range: 16, duration: 4, sfx: "link",      desc: "Tethers a foe and mirrors their knockback." },
  disable:   { name: "Disable",   key: "T", cd: 14.0, kind: "disable",   range: 16, duration: 1.6, kb: 4, color: 0xbbbbbb, sfx: "disable",  desc: "Briefly stuns and knocks back a target." },
